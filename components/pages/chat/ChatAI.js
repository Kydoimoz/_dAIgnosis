...
export default function Chat() {
    const [messages, setMessages] = useState([
        {
            isUser: false,
            text: "Hello, I'm dAIgnosis, your personal healthcare professional. Let me know any health-related difficulty and I will do a quick check on you :)"
        }
    ]);
    ...
    const sendMessageTodAIgnosis = async (e) => {
        //

        //
        e.preventDefault();
        if (input.trim() === "") return;
        const newUserMessage = { isUser: true, text: input.trim() };
        ...
        try {
            ...
            const dAIgnosis_Message = data.message || "Sorry, I couldn't understand your message, please retry.. ._.";
            console.log(dAIgnosis_Message);

            setMessages((previous) => [
                ...previous,
                { isUser: false, text: dAIgnosis_Message }
            ]);
            setTyping(false);
        }
        catch (err) {
